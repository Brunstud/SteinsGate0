...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/building1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log building1_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source building1_rom.tcl
