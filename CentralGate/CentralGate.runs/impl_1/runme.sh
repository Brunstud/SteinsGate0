...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Gate_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Gate_test.tcl -notrace
