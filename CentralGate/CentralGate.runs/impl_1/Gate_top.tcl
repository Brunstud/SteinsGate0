...
set rc [catch {
  ...
  add_files -quiet D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/synth_1/Gate_top.dcp
  ...
  link_design -top Gate_top -part xc7a100tcsg324-1
  write_hwdef -file Gate_top.hwdef
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force Gate_top_opt.dcp
  report_drc -file Gate_top_drc_opted.rpt
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force Gate_top_placed.dcp
  report_io -file Gate_top_io_placed.rpt
  report_utilization -file Gate_top_utilization_placed.rpt -pb Gate_top_utilization_placed.pb
  report_control_sets -verbose -file Gate_top_control_sets_placed.rpt
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force Gate_top_routed.dcp
  report_drc -file Gate_top_drc_routed.rpt -pb Gate_top_drc_routed.pb
  report_timing_summary -warn_on_violation -max_paths 10 -file Gate_top_timing_summary_routed.rpt -rpx Gate_top_timing_summary_routed.rpx
  report_power -file Gate_top_power_routed.rpt -pb Gate_top_power_summary_routed.pb -rpx Gate_top_power_routed.rpx
  report_route_status -file Gate_top_route_status.rpt -pb Gate_top_route_status.pb
  report_clock_utilization -file Gate_top_clock_utilization_routed.rpt
...
set rc [catch {
  ...
  catch { write_mem_info -force Gate_top.mmi }
  write_bitstream -force Gate_top.bit 
  catch { write_sysdef -hwdef Gate_top.hwdef -bitfile Gate_top.bit -meminfo Gate_top.mmi -file Gate_top.sysdef }
