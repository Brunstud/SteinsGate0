...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/building2_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log building2_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source building2_rom.tcl
