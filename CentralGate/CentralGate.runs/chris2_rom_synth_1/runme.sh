...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/chris2_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chris2_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chris2_rom.tcl
