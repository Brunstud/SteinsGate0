...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/road1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log road1_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source road1_rom.tcl
