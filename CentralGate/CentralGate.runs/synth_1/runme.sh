...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gate_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Gate_test.tcl
