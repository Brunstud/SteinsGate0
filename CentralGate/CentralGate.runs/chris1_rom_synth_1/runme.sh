...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/chris1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chris1_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chris1_rom.tcl
