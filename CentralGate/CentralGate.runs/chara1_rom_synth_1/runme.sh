...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/CentralGate/CentralGate.runs/chara1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chara1_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chara1_rom.tcl
