...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/SteinsGate0/SteinsGate0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Gate0_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Gate0_top.tcl -notrace
