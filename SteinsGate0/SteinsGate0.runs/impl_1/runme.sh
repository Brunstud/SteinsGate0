...
HD_PWD='D:/Program/vivado/SteinsGate0/SteinsGate0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_driver.vdi -applog -m64 -messageDb vivado.pb -mode batch -source VGA_driver.tcl -notrace
