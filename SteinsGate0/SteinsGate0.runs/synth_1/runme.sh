...
HD_PWD='D:/Program/vivado/SteinsGate0/SteinsGate0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_driver.vds -m64 -mode batch -messageDb vivado.pb -notrace -source VGA_driver.tcl
