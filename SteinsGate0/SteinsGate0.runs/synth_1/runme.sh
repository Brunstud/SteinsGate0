...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/SteinsGate0/SteinsGate0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gate0_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Gate0_top.tcl
