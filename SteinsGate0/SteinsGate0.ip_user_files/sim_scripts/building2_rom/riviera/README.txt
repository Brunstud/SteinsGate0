...
switch to the './building2_rom.sh' script.

./building2_rom.sh -reset_run
...
./building2_rom.sh -noclean_files

For more information on the script, please type './building2_rom.sh -help'.
