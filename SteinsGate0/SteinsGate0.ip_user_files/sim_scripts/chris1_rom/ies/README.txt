...
#
# Generated by export_simulation on Sun Jan 14 17:14:55 +0800 2024
#
################################################################################
...
switch to the './chris1_rom.sh' script.

./chris1_rom.sh -reset_run
...
./chris1_rom.sh -noclean_files

For more information on the script, please type './chris1_rom.sh -help'.
