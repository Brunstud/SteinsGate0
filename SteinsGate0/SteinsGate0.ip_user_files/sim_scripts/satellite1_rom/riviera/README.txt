...
#
# Generated by export_simulation on Sun Jan 14 17:14:57 +0800 2024
#
################################################################################
...
switch to the './satellite1_rom.sh' script.

./satellite1_rom.sh -reset_run
...
./satellite1_rom.sh -noclean_files

For more information on the script, please type './satellite1_rom.sh -help'.
