...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/RotationSensor/RotationSensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RotaryEncoder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source RotaryEncoder.tcl -notrace
