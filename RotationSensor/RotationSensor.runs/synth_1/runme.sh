...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/RotationSensor/RotationSensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RotaryEncoder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source RotaryEncoder.tcl
