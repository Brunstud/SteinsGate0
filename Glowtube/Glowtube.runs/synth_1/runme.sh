...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/Glowtube/Glowtube.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ssd.vds -m64 -mode batch -messageDb vivado.pb -notrace -source test_ssd.tcl
