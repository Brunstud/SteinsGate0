...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/Glowtube/Glowtube.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ssd.vdi -applog -m64 -messageDb vivado.pb -mode batch -source test_ssd.tcl -notrace
