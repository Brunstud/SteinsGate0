...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/GameGraphic/GameGraphic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vga_test.tcl
