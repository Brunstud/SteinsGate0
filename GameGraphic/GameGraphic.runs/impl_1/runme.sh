...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/GameGraphic/GameGraphic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vga_test.tcl -notrace
