...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/GameGraphic/GameGraphic.runs/satellite1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log satellite1_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source satellite1_rom.tcl
