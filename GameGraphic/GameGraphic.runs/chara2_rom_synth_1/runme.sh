...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/GameGraphic/GameGraphic.runs/chara2_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chara2_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chara2_rom.tcl
