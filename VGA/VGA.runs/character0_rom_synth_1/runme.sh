...
HD_PWD='D:/Program/vivado/SteinsGate0_GIT/VGA/VGA.runs/character0_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log character0_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source character0_rom.tcl
